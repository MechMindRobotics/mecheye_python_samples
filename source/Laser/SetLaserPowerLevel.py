...
class SetPowerLevel(object):
    ...
    def connect_device_info(self):
        ...
        show_error(self.device.set_laser_settings(laser_settings.get_mode(), laser_settings.get_start(
        ), laser_settings.get_end(), laser_settings.get_count(), 40))
